...
static fields_details_t *
parse_fields_details(field_infos_t *field_infos, data_input_t *terms_in, uint32_t terms_in_length);
...
block_tree_term_reader_t *block_tree_term_reader_new(field_infos_t *field_infos,
                                                     data_input_t *terms_in, uint32_t terms_in_length,
